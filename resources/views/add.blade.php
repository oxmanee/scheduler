    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <input type="text" name="namePatient" class="form-control" id="namePatient" required>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card border-primary mb-3 add-patient">
                ...
                <div class="card-body">
                    <form id="addDocForm" action="{{url('/addDoc')}}" method="post">
                        {!! csrf_field() !!}
                        <div class="row">
                            <div class="col-md-3 field-label-responsive">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                        <div class="input-group-addon" style="width: 2.6rem"></div>
                                        <input type="text" name="nameDoc" class="form-control" id="nameDoc" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="submit" id="addDoc" class="btn btn-outline-primary float-right">Save</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#addDocForm").submit(function() {
            ...
            if (ste < fts || ste < fte || ste < sts || sts < fte || sts < fts || fte < fts) {
